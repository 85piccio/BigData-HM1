...
${OBJECTDIR}/heap_ib/bheap.o: heap_ib/bheap.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/heap_ib/bheap.o heap_ib/bheap.c

${OBJECTDIR}/heap_ib/testHeap.o: heap_ib/testHeap.c 
	${MKDIR} -p ${OBJECTDIR}/heap_ib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/heap_ib/testHeap.o heap_ib/testHeap.c

${OBJECTDIR}/heap_ib/vector.o: heap_ib/vector.c 
	${MKDIR} -p ${OBJECTDIR}/heap_ib
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/heap_ib/vector.o heap_ib/vector.c
...
${OBJECTDIR}/multiwayMergesort.o: multiwayMergesort.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/multiwayMergesort.o multiwayMergesort.c
